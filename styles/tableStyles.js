...
function injectMinimalStyles() {
    ...
    style.textContent = `
        ...
        /* =====================================================
           ...
           Uses html body prefix for maximum specificity to beat
           any Webflow theme rules. Explicit colors instead of
           'inherit' because sticky cells don't reliably inherit
           through Tabulator's positioning.
           ===================================================== */
        html body .tabulator-row .tabulator-cell.tabulator-frozen,
        html body .tabulator-row .tabulator-frozen {
        ...
        html body .tabulator-row.tabulator-row-even .tabulator-cell.tabulator-frozen,
        html body .tabulator-row:nth-child(even) .tabulator-cell.tabulator-frozen,
        html body .tabulator-row.tabulator-row-even .tabulator-frozen,
        html body .tabulator-row:nth-child(even) .tabulator-frozen {
            background-color: #fafafa !important;
        }
        /* Odd rows — explicit background on frozen cells */
        html body .tabulator-row.tabulator-row-odd .tabulator-cell.tabulator-frozen,
        html body .tabulator-row:nth-child(odd) .tabulator-cell.tabulator-frozen,
        html body .tabulator-row.tabulator-row-odd .tabulator-frozen,
        html body .tabulator-row:nth-child(odd) .tabulator-frozen {
            background-color: #ffffff !important;
        }
        /* Hover — explicit background on frozen cells */
        html body .tabulator-row:hover .tabulator-cell.tabulator-frozen,
        html body .tabulator-row:hover .tabulator-frozen {
...
function injectFullStyles() {
    ...
    style.textContent = `
        ...
        html body .tabulator-row .tabulator-frozen { background-color: #ffffff !important; }
        html body .tabulator-row:nth-child(even) .tabulator-frozen { background-color: #fafafa !important; }
        html body .tabulator-row:nth-child(odd) .tabulator-frozen { background-color: #ffffff !important; }
        html body .tabulator-row:hover .tabulator-frozen { background-color: #eff6ff !important; }
