// tables/nhlPlayerFD.js - NHL Player FanDuel DFS Table
// Based on NBA basketPlayerFD.js with NHL-specific changes:
// - Supabase endpoint: HockeyPlayerFD
...
export class NHLPlayerFDTable extends BaseTable {
    constructor(elementId) {
        super(elementId, 'HockeyPlayerFD');
    ...
    _injectDKStyles() {
        const styleId = 'nhl-fd-dfs-width-override';
    ...
    initialize() {
        ...
        const config = {
            ...
            dataLoaded: (data) => {
                console.log(`NHL FD DFS loaded ${data.length} records`);
            ...
            ajaxError: (error) => { console.error("Error loading NHL FD DFS data:", error); }
        };
        ...
        this.table.on("tableBuilt", () => {
            console.log("NHL FD DFS table built");
            setTimeout(() => {
    ...
    _doCalculateAndApplyWidths() {
        ...
        try {
            ...
            this.ensureNameColumnWidth();
        } catch (error) { console.error('Error in NHL FD DFS calculateAndApplyWidths:', error); }
    }
    ...
    scanDataForMaxWidths(data) {
        ...
        const maxWidths = { "Player Team": 0, "Player FD Position": 0 };
        ctx.font = '600 12px "Segoe UI", Tahoma, Geneva, Verdana, sans-serif';
        const HP = 16, SI = 16;
        const ftt = { "Player Team": "Team", "Player FD Position": "Position" };
    ...
    getColumns(isSmallScreen = false) {
        ...
        return [
            ...
            { title: "Position", field: "Player FD Position", widthGrow: 0, minWidth: 60, sorter: "string", headerFilter: createCustomMultiSelect, resizable: false, hozAlign: "center", cssClass: "standalone-header" },
            { title: "Price", field: "Player FD Price", widthGrow: 0, minWidth: 70, sorter: function(a, b) { return self.priceSorter(a, b); }, headerFilter: createMinMaxFilter, headerFilterFunc: minMaxFilterFunction, headerFilterLiveFilter: false, resizable: false, hozAlign: "center", formatter: priceFormatter, cssClass: "standalone-header" },
